...
client.on("ready", () => {
    ...
    let channel = client.channels.cache.get("1086829118349389985"); // ID DA CATEGORIA DO CANAL DE VOZ
          ...
          const row = new Discord.MessageActionRow()
           .addComponents(
             new Discord.MessageButton()
               ...
               .setLabel('Comprar')
               .setEmoji("<:carrinho_loja:1053746702315700236>")
               .setStyle('SUCCESS'),
        );
            
        const embed = new Discord.MessageEmbed()
          .setTitle(`${config.get(`title`)} | Produtos`)
          .setDescription(`
\`\`\`
           ...
           const row = new Discord.MessageActionRow()
             .addComponents(
               new Discord.MessageButton()
                 ...
                 .setLabel('')
                 .setEmoji("<:menoscash:1087216589994197032>")
                 .setStyle('SECONDARY'),
           )
             .addComponents(
               new Discord.MessageButton()
                 ...
                 .setLabel('Comprar')
                 .setEmoji('<:certocash:1087216553671528488>')
                 .setStyle('SUCCESS'),
           )
             .addComponents(
               new Discord.MessageButton()
                 ...
                 .setLabel('')
                 .setEmoji("<:maiscash:1087216776099663902>")
                 .setStyle('SECONDARY'),
           )
             .addComponents(
               new Discord.MessageButton()
                 ...
                 .setLabel('Cancelar')
                 .setEmoji('<a:Royal:1057418909470445698>')
                 .setStyle('DANGER'),
           );
                     ...
                     const row = new Discord.MessageActionRow()
                       .addComponents(
                         new Discord.MessageButton()
                           ...
                           .setLabel('Cupom')
                           .setEmoji('<:cupomcash:1087216557735804978>')
                           .setStyle('PRIMARY'),
                     )
                       .addComponents(
                         new Discord.MessageButton()
                       ...
                       .addComponents(
                         new Discord.MessageButton()
                           ...
                           .setLabel('Cancelar')
                           .setEmoji('<a:black_naoverificado_B13:1057418909470445698>')
                           .setStyle('DANGER'),
                     );
                           ...
                           if (intera2.customId === "continuarboton") {
                             ...
                             var payment_data = {
                               ...
                               payment_method_id: 'pix',
                                payer: {
                                  email: 'emersonlopescell@gmail.com',
                                  first_name: 'Emerson',
                                  last_name: 'Lopes',
                                   identification: {
                                     type: 'CPF',
                               ...
                               mercadopago.payment.create(payment_data).then(function (data) {
                                 ...
                                 const row = new Discord.MessageActionRow()
                                   .addComponents(
                                     new Discord.MessageButton()
                                       .setCustomId('codigo')
                                       .setEmoji("<:pixcash:1087216597489430548>")
                                   ...
                                   .addComponents(
                                     new Discord.MessageButton()
                                       .setCustomId('qrcode')
                                       .setEmoji("<:qrcode:1065338297565593701>")
                                       .setLabel("QR Code")
                                       .setStyle('SUCCESS'),
                                 )
                                   .addComponents(
                                           ...
                                           const removed = a.splice(0, Number(quantidade1));
                                            db.set(`${severi}.conta`, a);
                                             const embedentrega = new Discord.MessageEmbed()
                                               ...
                                               .setDescription(`**🛒 | Produtos:** \n  \`\`\` 1º| ${removed.join ("\n")}\`\`\`\n**✨ | Acesse o Email [aqui](https://mail2web.com) \n** ✨ | Id da Compra:** ${data_id}\n\n**⭐ | Avalie a nossa loja [aqui](https://discord.com/channels/1086787750272974918/1095542513575657603)** `)
                                               .setColor(config.get(`color`))
                                               .setThumbnail(client.user.displayAvatarURL())
...
\`\`\``)
  ...
  client.on("messageCreate", message => {
    ...
    .setColor("BLACK")
    .setDescription(`👋 | Olá <@${message.author.id}>, sou um bot de vendas automáticas e o meu prefixo é \` ${config.get(`prefix`)} \`veja a minha lista de comandos com \`${config.get(`prefix`)}ajuda\`, caso queira um bot igual a este só chamar o** ImTralha#9032 **na DM**`)
